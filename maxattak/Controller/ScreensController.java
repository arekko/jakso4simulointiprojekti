...
public class ScreensController extends StackPane {
    ...
    private final ModelController moco;
    private MenuController meco;
    
    public ScreensController(ModelController moco) {
        super();
        this.moco = moco;
    }
            ...
            if (!getChildren().isEmpty()) {    //if there is more than one screen
                Timeline fade = new Timeline(
                    ...
                    public void handle(ActionEvent t) {
                        ...
                        System.out.println(getChildren().get(0).getId().toString());
     ...
     * @return the moco
     */
    public ModelController getMoco() {
        return moco;
    }
